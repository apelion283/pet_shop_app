                ...
                title: Row(
                    ...
                    children: [
                      ...
                      _isShimmer
                          ...
                          : Text(
                              context
                                  .tr("pet_profile", args: [state.pet!.name]),
                              style: TextStyle(
                                  color: AppColor.white,
                                  fontWeight: FontWeight.w500,
                                  fontSize: 18)),
                        ...
                        children: [
                          ...
                          _isShimmer
                              ...
                              : CircleAvatar(
                                  ...
                                  child: CircleAvatar(
                                    backgroundImage:
                                        NetworkImage(state.pet?.imageUrl ?? ""),
                                    radius: 50,
                                  ),
                                ),
                          SizedBox(
                                ...
                                : Column(
                                    ...
                                    children: [
                                      SectionHeader(
                                          ...
                                          sectionName: context.tr('about_pet',
                                              args: [state.pet!.name])),
                                      SizedBox(
                                        height: 8,
                                      ),
                                      AutoScrollAfterFillMaxHeight(
                                          maxHeight: MediaQuery.of(context)
                                                  ...
                                                  .height *
                                              0.3,
                                          textToShow: state.pet!.description,
                                          textStyle: TextStyle(
                                              fontSize: 15,
                              ...
                              child: Column(
                                ...
                                children: [
                                  SectionHeader(
                                      ...
                                      sectionName: context.tr('pet_status',
                                          args: [state.pet!.name])),
                                  SizedBox(
                                    height: 8,
                                  ),
                                  PetStatusRow(
                                      ...
                                      value: Row(
                                        children: [
                                          ...
                                          Text(context.tr(state.pet!.gender
                                              ? 'male'
                                              : 'female'))
                                        ],
                                      )),
                            ...
                            _isShimmer
                                ...
                                : Text(
                                    ...
                                    MoneyFormatHelper.formatVNCurrency(
                                        state.pet!.price * CurrencyRate.vnd)
                                  ]),
